...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mleap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6515&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mleap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mleap` can be installed with:

```
conda install mleap
```

It is possible to list all of the versions of `mleap` available on your platform with:
